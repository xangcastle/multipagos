...
class Detalle(models.Model):
    ...
    producto = models.CharField(max_length=20, null=True, blank=True)
    ...
    cuenta_cobro = models.CharField(max_length=20, null=True, blank=True)
    servicio = models.CharField(max_length=200, null=True, blank=True)
    factura_interna = models.CharField(max_length=20, null=True, blank=True)
    no_cupon = models.CharField(max_length=20, null=True, blank=True)
    no_fiscal = models.CharField(max_length=20, null=True, blank=True)
    cuenta_cobro = models.CharField(max_length=20, null=True, blank=True)
    ...
    tipo_mora = models.CharField(max_length=20, null=True, blank=True)
    ...
    tel_contacto = models.CharField(max_length=20, null=True, blank=True)
    tel_instalacion = models.CharField(max_length=20, null=True, blank=True)
    tel_contacto_cliente = models.CharField(max_length=20, null=True,
        blank=True)
    ...
    recurzo_externo = models.CharField(max_length=20, null=True, blank=True)
