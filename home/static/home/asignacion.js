            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < barrios.length; i++){
                        ...
                        row += '<td><div class="input-group input-sm"  style="width:180px"><span class="input-group-addon">' + barrio.cortes + '</span><input step="1" min="0" max="' + barrio.cortes + '" type="number" name="corte" class="form-control tableinput" ><span class="input-group-addon"><input type="checkbox" class="ckSelectAll"/></span></div></td>';
